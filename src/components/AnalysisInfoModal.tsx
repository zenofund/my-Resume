      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-4 sm:p-6 space-y-4 text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            <p>
              The algorithm is generated by Zolla as part of my comprehensive analysis. I consider several factors when determining the compatibility score, not just the number of keyword matches. These factors include:
            </p>
